...
FLUX_NGROK_URL = "https://your-flux-ngrok-url.ngrok.io"  # Replace with your Flux ngrok URL
...
def image_to_image_tool(image_path: str, prompt: str) -> str:
    ...
    # Upload image to your ngrok server
    try:
        ...
        print(f"DEBUG: Received result from ngrok", file=sys.stderr)
    except Exception as e:
        return f"Error generating image: {str(e)}"

    # Convert returned base64 to file
    try:
